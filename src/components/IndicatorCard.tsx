...
export function IndicatorCard({ indicator, index }: IndicatorCardProps) {
  ...
  return (
    ...
    >
      <Card className="bg-dashboard-card border-slate-700/50 shadow-lg hover:shadow-dashboard-accent/20 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
